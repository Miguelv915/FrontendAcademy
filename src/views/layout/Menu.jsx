...
export default function Menu() {
  ...
  const [rutaPrincipa, setrutaPrincipa]= useState("/")

  const  rutasAlumno = ["alumnos","apoderados"]
  const  rutasPago = ["pagos"]
  const  rutasCiclo = ["ciclos","gesciclos"]
  const  rutasUsuarios = ["usuarios"]

  useEffect(() => {
    const ruta = location.pathname;
    const segmentos = ruta.split('/');
    setrutaPrincipa(segmentos[1]);
    console.log(segmentos[1]);
    console.log("rutasAlumno.includes(rutaPrincipa) ", rutasAlumno.includes(rutaPrincipa) );
    console.log("rutasPago.includes(rutaPrincipa) ", rutasPago.includes(rutaPrincipa) );
    console.log("rutasCiclo.includes(rutaPrincipa) ", rutasCiclo.includes(rutaPrincipa) );

  }, [location.pathname]); // Agregamos location.pathname como dependencia para que se ejecute el efecto cuando cambie
  ...
  //     let body = { txt_idusu: dtUser.usu_id, txt_idtusu: dtUser.tpu_id, vcodEmpresa:cook_idEmp};
  ...
  // },[dtUser.usu_id,dtUser.tpu_id,cook_idEmp])
  ...
  return (
    <aside id="layout-menu" className="layout-menu menu-vertical menu bg-menu-theme">
                    ...
                    <ul className="menu-inner py-1">
                        ...
                        {/* Alumno*/}
                        <li className={`menu-item ${ rutasAlumno.includes(rutaPrincipa) ? 'active open' : ''}`}>
                            ...
                            <ul className="menu-sub">
                                <li className={`menu-item ${rutaPrincipa == 'alumnos'? 'active ' : ''}`}>
                                    {/* <a href="/listalumnos" className="menu-link">
                                        <div data-i18n="Collapsed menu">listalumnos</div>
                                        <div >listalumnos</div>
                                ...
                                <li className={`menu-item ${rutaPrincipa == 'apoderados'? 'active ' : ''}`}>
                                    {/* <a href="layouts-content-navbar.html" className="menu-link">
                                        <div data-i18n="Content navbar">Apoderados </div>
                                    </a> */}
                        ...
                        {/* PAagos */}
                        <li className={`menu-item ${ rutasPago.includes(rutaPrincipa) ? 'active open' : ''}`}>
                            <a href="" className="menu-link menu-toggle">
                                <i className="menu-icon tf-icons bx bx-layout" />
                                <div >Pagos</div>
                            </a>
                            <ul className="menu-sub">
                                <li className={`menu-item ${rutaPrincipa == 'pagos'? 'active ' : ''}`}>
                        ...
                        {/* Ciclos */}
                        <li className={`menu-item ${ rutasCiclo.includes(rutaPrincipa)? 'active open' : ''}`}>
                            <a href="" className="menu-link menu-toggle">
                                <i className="menu-icon tf-icons bx bx-layout" />
                                <div >Ciclos</div>
                            </a>
                            <ul className="menu-sub">
                                <li className={`menu-item ${rutaPrincipa == 'ciclos'? 'active ' : ''}`}>
                                    {/* <a href="/ciclos" className="menu-link">
                                        <div data-i18n="Collapsed menu">listalumnos</div>
                                        <div >Lis.Ciclos</div>
                                    </a> */}
                                    <NavLink to="/ciclos"  className="menu-link" >
                                    <div >Ciclos</div>
                                  </NavLink>
                                </li>
                                <li className={`menu-item ${rutaPrincipa == 'gesciclos'? 'active ' : ''}`}>
                                    {/* <a href="/ciclos" className="menu-link">
                                        <div data-i18n="Collapsed menu">listalumnos</div>
                                        <div >Lis.Ciclos</div>
                                    </a> */}
                                    <NavLink to="/gesciclos"  className="menu-link" >
                                    <div >Gestion Ciclos</div>
                                  </NavLink>
                                </li>
                                <li className="menu-item">
                                    <a href="layouts-content-navbar.html" className="menu-link">
                        ...
                        {/* Usuarios */}
                        <li className={`menu-item ${ rutasUsuarios.includes(rutaPrincipa)? 'active open' : ''}`}>
                            <a href="" className="menu-link menu-toggle">
                                <i className="menu-icon tf-icons bx bx-layout" />
                                <div >Usuarios</div>
                            </a>
                            <ul className="menu-sub">
                                <li className={`menu-item ${rutaPrincipa === 'usuarios'? 'active ' : ''}`}>
                                    {/* <a href="/ciclos" className="menu-link">
                                        <div data-i18n="Collapsed menu">listalumnos</div>
                                        <div >Lis.Ciclos</div>
                                    </a> */}
